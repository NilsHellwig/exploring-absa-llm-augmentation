...
DEFAULT_SPLIT = 0
DEFAULT_MODEL_ID = 0
DEFAULT_FEW_SHOT_SETTING = "random"

# Override default parameters if command-line arguments are provided
if len(sys.argv) > 3:
    ...
    SPLIT = DEFAULT_SPLIT
    FEW_SHOTS = DEFAULT_FEW_SHOT_SETTING

DATASET_PATH = f'../07 train models/real/split_{SPLIT}.json'
LABELS_AND_EXAMPLES_PATH = f"few_shot_examples/few_shot_examples_{FEW_SHOT_SETTING}.json"
...
SEED = int(f"43{SPLIT}{MODEL_ID}")

N_RETRIES = 25

# ABSA labels and sentiment polarities
...
# List of available models and their local file paths
MODELS = ["Llama3_8B", "Llama3_70B", "Llama13B",
          "Llama70B", "Falcon40B", "GPT-3"]
MODEL_PATHS = {
    "Llama3_8B": "llm_models/llama-3-8b.Q4_0.gguf",
    "Llama3_70B": "llm_models/Meta-Llama-3-70B-Q4_K_M.gguf",
    "Llama13B": "llm_models/llama-2-13b.Q4_0.gguf",
    "Llama70B": "llm_models/llama-2-70b.Q4_0.gguf",
    "Falcon40B": "llm_models/falcon-40b-Q4_K_S.gguf"
}
