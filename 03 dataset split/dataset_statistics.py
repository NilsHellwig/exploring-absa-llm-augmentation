...
def get_statistics_for_synthetic_data(statistics, dataset_json):
    ...
    for retry_reason in ["llm_invalid_xml_schema", "llm_invalid_xml_tags", "llm_aspect_polarity_in_text_but_not_in_label", "llm_more_than_one_sentences", "llm_no_german_language"]:
